...
namespace UniStorm
{
    public class UniStormSystem : MonoBehaviour
    {
        ...
        public UnityEngine.InputSystem.Key UniStormMenuKey = UnityEngine.InputSystem.Key.Escape;
#endif
        ...
        public UnityEngine.WindZone UniStormWindZone;
        ...
        void Awake()
        {
            ...
            Instance = this;
            m_UniStormClouds = FindAnyObjectByType<UniStormClouds>();
        ...
        public void InitializeWeather(bool UseWeatherConditions)
        {
            ...
            if (FogType == FogTypeEnum.UnistormFog)
            {
                ...
                if (CurrentWeatherType.PrecipitationWeatherType == WeatherType.Yes_No.Yes)
                {
                    ...
                    SunObjectMaterial.SetFloat("_OpaqueY", 575);
                ...
                else if (CurrentWeatherType.PrecipitationWeatherType == WeatherType.Yes_No.No)
                {
                    ...
                    m_CloudDomeMaterial.SetFloat("_FogBlendHeight", (1-CurrentWeatherType.FogHeight));
                    SunObjectMaterial.SetFloat("_OpaqueY", 20);
                    SunObjectMaterial.SetFloat("_TransparentY", 0);
                }
        ...
        void TransitionWeather()
        {
            ...
            if (CurrentWeatherType.PrecipitationWeatherType == WeatherType.Yes_No.Yes)
            {
                ...
                SunHeightCoroutine = StartCoroutine(SunHeightSequence(10 * TransitionSpeed, 575, 400));
            ...
            else if (CurrentWeatherType.PrecipitationWeatherType == WeatherType.Yes_No.No)
            {
                ...
                SunHeightCoroutine = StartCoroutine(SunHeightSequence(10 * TransitionSpeed, 20, 0));
        ...
        void UpdateColors()
        {
            ...
            SunObjectMaterial.SetFloat("_PlayerY", PlayerTransform.position.y);
        ...
        public void CheckGeneratedWeather()
        {
            ...
            if (m_GeneratedOdds <= m_PrecipitationOdds && PrecipiationWeatherTypes.Count != 0 || NonPrecipiationWeatherTypes.Count == 0 && PrecipiationWeatherTypes.Count != 0)
            {
                TempWeatherType = PrecipiationWeatherTypes[Random.Range(0, PrecipiationWeatherTypes.Count)];
            }
            else if (m_GeneratedOdds > m_PrecipitationOdds && NonPrecipiationWeatherTypes.Count != 0 || NonPrecipiationWeatherTypes.Count != 0 && PrecipiationWeatherTypes.Count == 0)
            {
                TempWeatherType = NonPrecipiationWeatherTypes[Random.Range(0, NonPrecipiationWeatherTypes.Count)];
            }
